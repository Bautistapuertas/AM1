...
import { ContinuityVisualizer, TheoremsVisualizer, IntegralsVisualizer, LimitsVisualizer, DerivativesVisualizer, FunctionStudyVisualizer } from './components/MathGraphs';
...
export default function App() {
  ...
  const renderMathText = (text) => {
    ...
    return actualLines.map((line, i) => {
      ...
      if (line.startsWith('[GRAFICO:Limites]')) return <LimitsVisualizer key={i} />;
      if (line.startsWith('[GRAFICO:Derivadas]')) return <DerivativesVisualizer key={i} />;
      if (line.startsWith('[GRAFICO:Estudio]')) return <FunctionStudyVisualizer key={i} />;
